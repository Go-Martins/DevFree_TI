  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-16 py-8 px-6">
        <a
          href="https://wa.link/tlw0c4"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-verdeWhats text-white font-poppins font-medium text-pequeno rounded-full py-5 px-6 flex items-center gap-3 ring-3 ring-verdeEscuro hover:bg-verdeEscuro active:bg-opacity-20 focus:outline-none focus:ring focus:ring-verdeEscuro duration-75"
        >
        ...
        <h5 className="text-azulEscuro text-grande">
