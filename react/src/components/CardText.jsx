function CartText() {
  return (
    <div className="py-9 px-6 space-y-8 bg-bege">
    <div className="flex flex-col space-y-4 bg-bege">
      ...
      <div class="bg-azulEscuro mx-14 rounded-xl">
        <p className="text-bege font-poppins font-medium text-base text-center p-4">Então se liga nos nossos projetos abaixo</p>
      </div>
    </div>
  );
}
